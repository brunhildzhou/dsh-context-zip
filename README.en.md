...
The plugin ships a runtime check suite: 1360 checks pass with both `--installed` and `--deliverable` given. How to run it and what it covers is in `evidence/套件说明.md`.
